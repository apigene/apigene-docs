# 🧠 Copilot Overview Documentation

## Introduction

This product is designed to **transform how users interact with workplace applications**. By leveraging **natural language interfaces** and **AI-driven workflows**, it eliminates the need for switching between apps, reduces operational friction, and enhances productivity.
...
1. Connect your first application via the directory or schema upload.
2. Create a simple task to interact with the app.
3. Explore dashboards for usage insights.
4. Set up security policies and task sharing settings.
5. Inject organization or personal context to tailor responses.

---

## 💬 Feedback

We’re always looking to improve. Please reach out with feedback, suggestions, or questions as you explore the platform!