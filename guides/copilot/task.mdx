...
- [Delete Tasks](/guides/copilot/task#delete-tasks) -  Delete tasks Tasks can be removed when no longer needed
...
1. Hover on the task to reveal the horizontal elipsis icon.
