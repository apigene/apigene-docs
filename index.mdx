...
<CardGroup cols={2}>
  ...
  <Card title="Insights" icon="chart-mixed" href="/user-guide/insights">
    Monitor conversations, agents, workflows, and action analytics
  </Card>
...
### Insights
Analytics about your usage — conversations and LLM cost, agent performance, workflow health, and API action volume.

[View Insights →](/user-guide/insights)
