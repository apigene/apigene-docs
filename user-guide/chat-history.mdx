...
Your conversations appear in the left sidebar. The list follows the **Live** / **Design** workspace:

- **Live** — everyday chats and task runs
- **Design** — Design Agent sessions (Create / Extend)

Switch workspace to see the matching history. Use the thread filter (**All**, **Chats**, **Tasks**, **Design**) when you need a narrower view.
...
**Automatic Titling**
- AI generates descriptive titles in your [UI language](/user-guide/settings#change-ui-language)
...
- [Review Insights](/user-guide/insights) for usage insights
