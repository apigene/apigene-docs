...
### From the sidebar or user menu

Open **Design Agent** from the main sidebar (next to **New Chat**) or from the user navigation menu. Choose **Create** or **Extend** depending on whether you are defining a new agent or adding to an existing draft.
...
2. **Design Agent** — agent creation and management mode (**Create** or **Extend**)

The message input border turns blue in Design Agent so you can tell which mode you are in at a glance.

<Note>
The Chat / Design Agent toggle is available on the **home** (new chat) screen. From an ongoing thread, use the in-chat Design Agent shortcut card, the sidebar **Design Agent** item, or start a **New chat** to change modes.
</Note>
...
- From an existing thread, use the **Design Agent** shortcut card or **New chat**
