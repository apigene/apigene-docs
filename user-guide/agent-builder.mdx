...
Open **Agent Builder** from the main sidebar (next to **New Chat**) or from the user navigation menu. This starts a new Builder-mode session without hunting for the home-screen toggle.
...
<Note>
The Chat / Agent Builder toggle is available on the **home** (new chat) screen. From an ongoing thread, use the in-chat **Switch to Agent Builder** card, the sidebar **Agent Builder** item, or start a **New chat** to change modes.
</Note>
