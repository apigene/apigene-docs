...
How much of the request/response body is stored depends on your organization's **Interaction Recording** policy (full bodies, headers only, or disabled). See [Settings](/user-guide/settings#interaction-recording-organization).
