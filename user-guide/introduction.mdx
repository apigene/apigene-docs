...
<Frame>
  <img src="/images/product/app-menu.png" alt="Apigene application menu with navigation to product areas" style={{ borderRadius: '0.5rem' }} />
</Frame>

The left sidebar has two workspaces (toggle **Live** / **Design**):

- **Live** — **New Chat**, chat history, and **Tasks**. Use this to talk to apps and agents.
- **Design** — **Design Agent**, then **Build** (Agents, Applications, Skills, Context), **Monitor** (Actions, Workflows, Insights), and **Admin**. Use this to create and configure agents.

Organization members and phones stay in **Live**.
...
<CardGroup cols={2}>
  ...
  <Card title="OpenLegacy Hub" icon="cube" href="/user-guide/openlegacy">
    Connect Hub, install project OpenAPI as applications, and build Hub-ready agents
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Workflow History" icon="diagram-project" href="/user-guide/workflow-history">
    Inspect and replay past agent workflow runs
  </Card>
  <Card title="Insights" icon="chart-mixed" href="/user-guide/insights">
    Conversations, agents, workflows, and action analytics
  </Card>
...
- **[Viewing analytics](/user-guide/insights)** - Monitor usage patterns
