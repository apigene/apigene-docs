...
Navigate to **MCP Apps** from the application menu (admin). The list shows templates grouped by application, with search and actions to create, clone, edit, or delete.
