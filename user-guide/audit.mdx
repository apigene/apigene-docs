...
- **Settings changes**: Organization configuration updates (`org_settings`)
- **API tokens**: Generation of organization or user API access tokens (`api_token`)

## Accessing Audit Logs

In the **Design** workspace, open **Admin → Audit Logs**.
...
- **Settings** / **org_settings**: Organization configuration
- **API token** (`api_token`): Access token generation events
...
- [Check Insights](/user-guide/insights) for usage trends
