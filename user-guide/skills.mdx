...
In the **Design** workspace, open **Build → Skills**.
...
2. Choose a tab:
   - **Upload** — drop or select a `SKILL.md` file, or a `.zip` of a skill folder (`SKILL.md` at the zip root or in a wrapper folder such as `ol-deck/SKILL.md`, plus optional `scripts/`, `references/`, `assets/`)
