...
The Dashboard provides a comprehensive view of your Apigene Copilot usage across **Conversations** (chat and LLM spend), **Workflows** (run health), and **Actions** (API calls). Use it to understand adoption, cost, and reliability.

<Frame>
  <img src="/images/product/dashboard.png" alt="Dashboard with daily action usage chart" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
**Presets and date pickers**
- Quick presets (for example 7 / 30 / 90 days) plus custom start and end dates
- **Default**: Last 30 days

**Usage**
1. Pick a preset, or click the start / end date fields
2. Select your desired range
3. Dashboard updates automatically across the active tab
...
- Spot power users and quiet periods
- Correlate chat volume with LLM spend
...
Costs are **list-price estimates** from known model pricing — useful for trends and chargeback, not an invoice.

**Use Cases**
- Identify expensive models or providers
- Attribute spend to users
- Decide which models to keep enabled in [Settings](/user-guide/settings)

## Workflows

### Workflow KPIs and trends
...
- Find slow or failing steps
- See which agents and workflows drive the most volume
...
2. Start making actions and chats in Copilot (and run workflows when ready)
3. Open Dashboard tabs for Conversations, Workflows, and Actions
...
- [Open Workflow History](/user-guide/workflow-history) for individual workflow runs
- [Open Insights](/user-guide/insights) for per-agent performance analytics
- [Configure applications](/user-guide/applications) to improve success rates
- [Manage models and spend controls](/user-guide/settings) in organization settings
