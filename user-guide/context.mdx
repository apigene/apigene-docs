...
1. In the **Design** workspace, open **Build → Context**
2. Click **+ New Context** button
3. The context creation form appears

## Context Types

**Context Types** define reusable schemas/templates for how context items are structured (for example Knowledge, Tool, or custom types).

1. From the Context list, open **Context Types** (or go to `/context-type`)
2. Browse existing types, **import defaults**, or create a **New Type**
3. Edit a type’s name, summary, and structure
4. When creating a context item, select the appropriate type

Use types to keep org knowledge consistent and to help agents/MCP tools discover the right kind of context.
...
- [Monitor usage](/user-guide/insights) of your applications
